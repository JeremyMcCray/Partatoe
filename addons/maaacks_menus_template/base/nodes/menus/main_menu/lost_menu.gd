class_name LostMenu
extends Control
## Base menu scene that links to a game scene, an options menu, and menu.
...
## The scene to open when a player clicks the 'menu' button.
...
func _hide_menu_if_unset() -> void:
	if menu_packed_scene == null:
		menu_button.hide()
...
func _on_menu_button_pressed() -> void:
	_open_sub_menu(menu_packed_scene)
